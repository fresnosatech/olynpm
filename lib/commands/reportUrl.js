...
function reportUrl() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { content: pkg } = yield package_json_1.default.normalize(path).catch((err) => {
            if (err.code === "ENOENT") {
                npmlog_1.default.warn(constants_1.LOG_PREFIX, "package.json file not found.");
            }
            throw err;
        });
        ...
        Object.keys(dependencies).forEach((packageName) => {
            ...
            if (/^latest$/.test(versionRange)) {
                ...
                npmlog_1.default.info(constants_1.LOG_PREFIX, `Found: ${packageName}@${versionRange} -> ${versionRange}`);
                return;
            }
            ...
            npmlog_1.default.info(constants_1.LOG_PREFIX, `Found: ${packageName}@${versionRange} -> ${resolvedVersion}`);
